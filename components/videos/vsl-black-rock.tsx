...
export default function VSLBlackRock() {
  useEffect(() => {
    const loadPlayerScript = () => {
      ...
      script.src = "https://scripts.converteai.net/7811ed69-550c-4b89-9a28-8ab5dbe8db56/players/69359e59332125736afe6e6e/v4/player.js";
      script.async = true;
      script.onload = () => {
    ...
    return () => {
      const existingScript = document.querySelector('script[src*="69359e59332125736afe6e6e"]');
      if (existingScript) {
  ...
  return (
    ...
    <vturb-smartplayer 
      id="vid-69359e59332125736afe6e6e" 
      style={{ 
        width: "100%",
        margin: "0 auto", 
        display: "block",
